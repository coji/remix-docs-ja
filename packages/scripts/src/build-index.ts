import {
  type ProductId,
  products,
} from '@remix-docs-ja/base/features/product/products'
import { getOgpImageResponse } from '@remix-docs-ja/base/services/ogp-image.server'
...
export const buildIndex = async (productId: ProductId) => {
