...
export const TableOfContents = twc.ul`sticky top-8 hidden gap-2 pr-4 pb-8 text-sm leading-4 max-h-[calc(100dvh-48px-32px)] md:flex md:flex-col overflow-y-scroll`
